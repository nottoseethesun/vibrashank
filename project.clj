(defproject vibrashank "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "vibrashank.jar"

  :main vibrashank.server
  ...
  :profiles {:dev {:repl-options {:init-ns vibrashank.repl}
